...
const Footer = () => {
  ...
  const ourAddress = [
    { name: "Amberknana,sylhet", link: "/" },
    { name: "View in map", link: "/" },
  ];
  const oralHealth = [
    { name: "Emergency Doctors help", link: "/" },
    { name: "All department doctor availabe", link: "/" },
  ...
  return (
    <>
      <footer
        style={{ backgroundColor: "#0092db1a" }}
      ...
      >
        <form className="px-5 my-3 text-center">
          ...
          <div className="form-group text-center mt-2">
            <Link to="/dashboard">
              <button className="btn btn-secondary mr-3 text-white">
                Open Admin Panel
              </button>
            </Link>
          </div>
